...
<head>
    ...
    <link rel="stylesheet" href="/resources/vendor.css">
                ...
                <div class="s-home__slide s-home__slide--1">
                    <div class="row">
                        <div class="column large-12 s-home__slide-text">
                            <h2>
                            	 <span>Medicine management system</span>
                            </h2>
                            <p>
                            The Medicine management system (MMS) is an integrated software that handles different directions of workflows.
                            It manages the medicine records of different types of medicine.
                            </p>
                        </div>
                    </div>
